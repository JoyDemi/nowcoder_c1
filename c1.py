...
def qiushibaike():
    content = requests.get('http://www.qiushibaike.com/text/').content
...
def demo_list():
    ...
    print(12, listc)
    print(13, listb * 2)
    print(14, [0] * 14)  # memset(src,o,len)初始化
    tuplea = (1, 2, 3)
    listaa = [1, 2, 3]
    listaa.append(4)
    print(15, listaa)
...
def demo_dict():
    dicta = {4: 16, 1: 2, 2: 4, 3: 9}
    print(1, dicta)
    print(2, dicta.keys(), list(dicta.values()))
    if 1 in dicta.keys():
        print('true')
    else:
        print('flase')
...
class Admin(User):
    ...
    def __init__(self, name, uid, group):  # 成员函数，初始化
